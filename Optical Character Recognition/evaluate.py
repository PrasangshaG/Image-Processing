...
def main():
    ...
    with open('C:\\Users\\Prasangsha\\Documents\\Image Processing\\results.json') as file:
        preds = json.load(file)

    with open('C:\\Users\\Prasangsha\\Documents\\Image Processing\\groundtruth.json') as file:
